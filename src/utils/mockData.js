...
export const generateCompanies = () => {
  return [
    { id: 'CMP-001', username: 'trendyol', name: 'Trendyol', sector: 'E-Ticaret & Teknoloji', email: 'ik@trendyol.com', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Trendyol&background=F97316&color=fff', website: 'https://trendyol.com', location: 'İstanbul Maslak Kampüsü', description: 'Türkiye\'nin lider teknoloji ve e-ticaret platformu. İESÜ Kariyer Geliştirme Merkezi akredite sanayi ve staj partneri.', foundingYear: '2010', employeeCount: '5000+', openPositions: 8, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-002', username: 'getir', name: 'Getir', sector: 'Hızlı Teslimat & Mobil Yazılım', email: 'ik@getir.com', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Getir&background=5B21B6&color=fff', website: 'https://getir.com', location: 'İstanbul Levent', description: 'Öncü hızlı teslimat ve teknoloji şirketi. Mobil mühendislik, veri bilimi ve operasyon yönetimi stajları.', foundingYear: '2015', employeeCount: '10000+', openPositions: 5, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-003', username: 'aselsan', name: 'Aselsan', sector: 'Savunma Sanayii & Aviyonik', email: 'ik@aselsan.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Aselsan&background=0A2342&color=fff', website: 'https://aselsan.com.tr', location: 'Ankara Macunköy', description: 'Türkiye\'nin savunma elektroniği ve yüksek teknoloji üssü. Aday mühendislik, gömülü sistemler ve radar araştırmaları.', foundingYear: '1975', employeeCount: '9000+', openPositions: 12, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-004', username: 'ford', name: 'Ford Otosan', sector: 'Otomotiv & Otonom Sürüş', email: 'ik@ford.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Ford+Otosan&background=0284C7&color=fff', website: 'https://ford.com.tr', location: 'Kocaeli / Sancaktepe AR-GE', description: 'Geleceğin mobilite ve elektrikli araç teknolojileri geliştiricisi. AR-GE, makine ve yazılım mühendisliği programları.', foundingYear: '1959', employeeCount: '12000+', openPositions: 7, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-005', username: 'turkcell', name: 'Turkcell', sector: 'Telekomünikasyon & Bulut Bilişim', email: 'ik@turkcell.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Turkcell&background=EAB308&color=fff', website: 'https://turkcell.com.tr', location: 'İstanbul Maltepe Küçükyalı', description: 'Türkiye\'nin dijital operatörü ve bulut altyapı lideri. GNCTRKCLC genç yetenek, siber güvenlik ve yapay zeka stajları.', foundingYear: '1994', employeeCount: '8000+', openPositions: 10, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-006', username: 'baykar', name: 'Baykar Teknoloji', sector: 'İHA Sistemleri & Yapay Zeka', email: 'ik@baykartech.com', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Baykar&background=DC2626&color=fff', website: 'https://baykartech.com', location: 'İstanbul Özdemir Bayraktar Milli Teknoloji Merkezi', description: 'Milli İHA ve SİHA teknolojileri, otonom uçuş kontrolü, derin öğrenme ve aviyonik mühendisliği araştırma merkezi.', foundingYear: '1984', employeeCount: '4500+', openPositions: 15, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-007', username: 'havelsan', name: 'Havelsan', sector: 'Savunma & Simülasyon Yazılımları', email: 'ik@havelsan.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Havelsan&background=1E3A8A&color=fff', website: 'https://havelsan.com.tr', location: 'Ankara ODTÜ Teknokent', description: 'Komuta kontrol sistemleri, eğitim simülatörleri ve siber güvenlik yazılımlarında öncü kurum.', foundingYear: '1982', employeeCount: '4000+', openPositions: 6, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-008', username: 'thy', name: 'Türk Hava Yolları', sector: 'Havacılık & Lojistik Teknolojileri', email: 'ik@thy.com', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=THY&background=990000&color=fff', website: 'https://turkishairlines.com', location: 'İstanbul Havalimanı Yerleşkesi', description: 'Dünyanın en çok ülkesine uçan global bayrak taşıyıcısı. Havacılık bilişimi, veri analitiği ve müşteri deneyimi.', foundingYear: '1933', employeeCount: '30000+', openPositions: 9, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-009', username: 'roketsan', name: 'Roketsan', sector: 'Füze Sistemleri & Uzay Teknolojileri', email: 'ik@roketsan.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Roketsan&background=0F766E&color=fff', website: 'https://roketsan.com.tr', location: 'Ankara Elmadağ', description: 'Milli roket ve füze sistemleri üreticisi. İtki sistemleri, aerodinamik ve güdüm kontrol mühendisliği.', foundingYear: '1988', employeeCount: '3500+', openPositions: 6, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-010', username: 'sisecam', name: 'Şişecam', sector: 'Global Sanayi & İleri Malzeme', email: 'ik@sisecam.com', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Şişecam&background=0284C7&color=fff', website: 'https://sisecam.com.tr', location: 'İstanbul Tuzla Genel Merkez', description: 'Düzcam, cam ev eşyası ve kimyasallar alanında global endüstri devi. Malzeme bilimi, endüstri mühendisliği ve dijital dönüşüm.', foundingYear: '1935', employeeCount: '24000+', openPositions: 4, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-011', username: 'siemens', name: 'Siemens Türkiye', sector: 'Endüstri 4.0 & Otomasyon', email: 'ik@siemens.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=Siemens&background=0D9488&color=fff', website: 'https://siemens.com.tr', location: 'İstanbul Kartal Kampüsü', description: 'Dijital endüstriler, akıllı altyapı ve elektrifikasyon çözümleri lideri.', foundingYear: '1856', employeeCount: '3000+', openPositions: 5, badges: ['verified', 'corporate_partner'] },
    { id: 'CMP-012', username: 'tusas', name: 'TUSAŞ (TAI)', sector: 'Havacılık ve Uzay Sanayii', email: 'ik@tusas.com.tr', password: 'password', role: 'company', avatar: 'https://ui-avatars.com/api/?name=TUSAŞ&background=1E40AF&color=fff', website: 'https://tusas.com.tr', location: 'Ankara Kahramankazan', description: 'Milli Muharip Uçak KAAN, HÜRJET, GÖKBEY ve ATAK projeleri mühendislik merkezi.', foundingYear: '1973', employeeCount: '14000+', openPositions: 18, badges: ['verified', 'corporate_partner'] }
  ];
};
