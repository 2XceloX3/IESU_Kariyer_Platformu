    ...
    <footer className="bg-iesu-primary py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3 font-medium text-[14px]">
              <li><a href="https://obs.esenyurt.edu.tr/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-iesu-accent hover:translate-x-1 transition-all flex items-center gap-2"><ChevronRight size={14} /> Öğrenci Bilgi Sistemi (OBS)</a></li>
              <li><a href="https://eslms.esenyurt.edu.tr/almsp" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-iesu-accent hover:translate-x-1 transition-all flex items-center gap-2"><ChevronRight size={14} /> İESÜZEM (Uzaktan Eğitim)</a></li>
              <li><a href="https://kutuphane.esenyurt.edu.tr/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-iesu-accent hover:translate-x-1 transition-all flex items-center gap-2"><ChevronRight size={14} /> Merkez Kütüphane</a></li>
              <li><button onClick={() => setView('staj')} className="text-blue-100 hover:text-iesu-accent hover:translate-x-1 transition-all flex items-center gap-2"><ChevronRight size={14} /> Gönüllü Staj Süreçleri</button></li>
              <li><button onClick={() => setView('sem')} className="text-blue-100 hover:text-iesu-accent hover:translate-x-1 transition-all flex items-center gap-2"><ChevronRight size={14} /> SEM (Sürekli Eğitim Merkezi)</button></li>
            </ul>
          </div>
        ...
        <div className="pt-6 border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[13px] text-blue-200 font-medium tracking-wide">2026 © İstanbul Esenyurt Üniversitesi Bilgi İşlem Daire Başkanlığı tarafından hazırlanmıştır.</p>
