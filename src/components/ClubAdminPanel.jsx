  ...
  if (managedClubs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
        ...
        <p className="text-sm text-gray-500 mt-2 text-center max-w-md">Herhangi bir kulübün başkanı veya yöneticisi değilsiniz. Kulüp kurmak için Kariyer Geliştirme Merkezi ile iletişime geçin.</p>
      </div>
    );
  }
