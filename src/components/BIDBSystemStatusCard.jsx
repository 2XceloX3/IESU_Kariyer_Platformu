      ...
      <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-50 shadow-xs">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="font-black text-sm sm:text-base tracking-tight text-slate-900 leading-none">BİDB Bilişim Sistem Durumu</h1>
              <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">Kampüs Altyapı ve Sunucu Sağlığı</span>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 w-full max-w-[900px] mx-auto p-4 lg:p-8 flex flex-col gap-6">
        <div className="bg-slate-900 text-white rounded-3xl p-8 shadow-xl border border-slate-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700/60 flex justify-between items-center">
              <div className="flex items-center gap-3">
