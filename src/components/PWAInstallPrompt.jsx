  ...
  return (
    <AnimatePresence>
      {showPrompt && (
        ...
        >
          <div className="w-12 h-12 rounded-xl bg-red-50 flex items-center justify-center text-iesu-red shrink-0">
            <Download size={24} />
          </div>
          ...
          <div className="flex flex-col gap-2 ml-2">
            <button 
              ...
              className="px-4 py-1.5 bg-iesu-red text-white text-xs font-bold rounded-lg hover:bg-red-700 transition-colors shadow-md"
            >
              Yükle
            </button>
            <button 
