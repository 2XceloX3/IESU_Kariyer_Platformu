      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <div><p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Toplam Öğrenci</p><p className="text-2xl font-black text-gray-900">{safeStudents.length}</p></div>
          </div>
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <div><p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Aktif Kullanıcı</p><p className="text-2xl font-black text-gray-900">{activeCount}</p></div>
          </div>
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center"><Briefcase size={24}/></div>
            <div><p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Staj Arayan</p><p className="text-2xl font-black text-gray-900">{internshipSeekers}</p></div>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                <th className="py-3 px-5 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Öğrenci</th>
                <th className="py-3 px-5 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Bölüm & Sınıf</th>
                <th className="py-3 px-5 text-[11px] font-bold text-gray-400 uppercase tracking-wider">İletişim</th>
                <th className="py-3 px-5 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Durum & Staj</th>
              ...
              {filtered.map(s => (
                <tr key={s.id} className="hover:bg-gray-50/50 transition group">
                  ...
                  <td className="py-3 px-5">
                    ...
                    <p className="text-[10px] font-bold text-gray-400 mt-0.5 uppercase">{s.year ? `${s.year}. Sınıf` : '-'}</p>
                  </td>
                  <td className="py-3 px-5">
