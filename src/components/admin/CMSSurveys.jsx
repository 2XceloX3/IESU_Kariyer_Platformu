                  ...
                  <tr className="hover:bg-slate-50/80 transition group cursor-pointer" onClick={() => setExpandedSurveyId(isExpanded ? null : s.id)}>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button onClick={(e) => { e.stopPropagation(); setExpandedSurveyId(isExpanded ? null : s.id); }} className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Yanıtları Gör">
      ...
      <div className="w-full lg:w-96 space-y-4">
        ...
        <div className="bg-white border-2 border-indigo-100 rounded-2xl shadow-sm overflow-hidden sticky top-6">
          ...
          <div className="p-5">
            ...
            <button disabled className="w-full mt-6 bg-gray-200 text-gray-400 font-bold py-2 rounded-lg text-xs cursor-not-allowed">
              Gönder (Test)
            </button>
          </div>
        </div>
