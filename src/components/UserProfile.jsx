          ...
          {currentUser?.id !== user?.id && (
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              <button 
                ...
                className={`flex-1 sm:flex-none flex justify-center items-center gap-2 px-5 py-2.5 rounded-full font-bold text-sm transition border ${isFollowing && userRole !== 'academic' ? 'bg-white border-iesu-navy text-[#0A2342] hover:bg-red-50' : 'bg-[#0A66C2] hover:bg-[#004182] border-[#0A66C2] text-white'}`}
              >
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fade-in">
          <div className="bg-white rounded-xl w-full max-w-lg shadow-2xl overflow-hidden border border-gray-100 flex flex-col">
            ...
            <div className="p-8 flex flex-col items-center justify-center bg-[#F8F9FC]">
              <div className="w-full max-w-sm aspect-video bg-white border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center text-gray-500 cursor-pointer hover:border-iesu-navy hover:bg-red-50/30 hover:text-[#0A2342] transition group">
