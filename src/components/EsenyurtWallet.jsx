      ...
      <main className="flex-1 w-full max-w-[1200px] mx-auto p-4 lg:p-8 flex flex-col gap-8">
        ...
        <div className="bg-slate-950 rounded-3xl p-8 md:p-12 shadow-xl relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between gap-8 border border-red-900">
          ...
          <div className="relative z-10 text-center md:text-left max-w-xl">
            <p className="text-iesu-darkRed font-bold uppercase tracking-widest text-xs mb-3 flex items-center justify-center md:justify-start gap-2 bg-indigo-950/50 w-fit px-3 py-1.5 rounded-full border border-indigo-900/30">
            ...
            <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-4 leading-tight">
              Kariyer Yolculuğunuz <br/><span className="text-iesu-darkRed">Tek Bir Yerde.</span>
            </h2>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/85 shadow-sm">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-black text-xs text-iesu-darkRed bg-indigo-50 border border-indigo-150 px-2 py-0.5 rounded">%{readinessScore}</span>
              </div>
              <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden mb-4 border border-slate-200/50">
                <motion.div initial={{ width: 0 }} animate={{ width: `${readinessScore}%` }} className="h-full bg-iesu-darkRed" />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/85 shadow-sm overflow-hidden flex flex-col">
              <div className="flex flex-col">
                {VERIFIED_SKILLS.map((trx, idx) => (
                  <div key={trx.id} className={`p-5 flex items-center justify-between hover:bg-slate-50 transition ${idx !== VERIFIED_SKILLS.length - 1 ? 'border-b border-slate-100' : ''}`}>
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 border shadow-sm ${trx.type === 'certificate' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-indigo-50 text-iesu-darkRed border-indigo-100'}`}>
                        {trx.icon}
                      </div>
                      <div>
              ...
              <button 
                ...
                className="w-full py-4 text-xs font-black uppercase tracking-wider text-iesu-darkRed hover:bg-indigo-50 transition border-t border-slate-100 flex items-center justify-center gap-2"
              >
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <button 
                  ...
                  className="w-full py-3.5 bg-iesu-darkRed hover:bg-iesu-darkRed text-white font-black rounded-xl text-xs uppercase tracking-widest transition"
                >
