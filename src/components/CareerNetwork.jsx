...
export default function CareerNetwork({ companies = [], academicStaff = [], setView, setSelectedUserId, currentUser }) {
  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-iesu-navy to-red-900 rounded-xl p-6 shadow-[0_8px_30px_rgb(185,28,28,0.2)] text-white relative overflow-hidden border border-red-800">
